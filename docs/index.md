...
- `docs/architecture.md`: Contract and test architecture, core flows, and invariants context.
  ...
  - Includes the LCC vault domain for `src/lcc/`, including `LCCVault`, `LCCVaultFactory`, and USD3 Notification Vault (`USD3l`) integration.
...
- `docs/lcc-deferred-full-closeout-bounce.md`: measured decision record for the deferred full-closeout bounce design.
- `docs/lcc-deferred-partial-withdraw.md`: decision record for deferring user-directed partial withdrawals.
