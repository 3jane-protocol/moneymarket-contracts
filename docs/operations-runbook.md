...
2. Once that lands, have a keeper call `USD3.syncTrancheShare()` (`USD3.sol:808`, `onlyKeepers`). This reads the variant and writes the fee bits; **step 1 has no effect on reports until this runs.**
