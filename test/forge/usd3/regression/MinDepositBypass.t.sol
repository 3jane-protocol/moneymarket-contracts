...
contract MinDepositBypassTest is Setup {
    ...
    function test_normal_minDeposit_enforcement() public {
        ...
        console2.log("[PASS] Normal deposit below minDeposit correctly rejected");
    }
    ...
    function test_minDeposit_bypass_with_deposit_max() public {
        ...
        console2.log("\nAlice balance:", belowMinAmount / 1e6, "USDC (below minimum)");
        ...
        console2.log("[PASS] Deposit with type(uint256).max correctly rejected");
    }
    ...
    function test_minDeposit_bypass_with_mint_max() public {
        ...
        console2.log("\nBob balance:", belowMinAmount / 1e6, "USDC (well below minimum)");
    ...
    function test_minDeposit_bypass_edge_case() public {
        ...
        console2.log("\nCharlie balance:", justBelowMin, "wei (exactly minDeposit - 1)");
    ...
    function test_exploit_scenario() public {
        ...
        uint256 sharesBefore = ITokenizedStrategy(address(usd3Strategy)).balanceOf(attacker);
