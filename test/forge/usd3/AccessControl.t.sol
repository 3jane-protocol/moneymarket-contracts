...
contract AccessControlTest is Setup {
    ...
    function test_maxOnCredit_readsFromProtocolConfig() public {
        ...
        assertEq(usd3Strategy.maxOnCredit(), 10_000, "Default maxOnCredit from MockProtocolConfig should be 100%");
    ...
    function test_setSUSD3_onlyManagement() public {
        ...
        assertEq(usd3Strategy.sUSD3(), address(susd3Strategy), "sUSD3 strategy should remain unchanged");
    }
    ...
    function test_setMinDeposit_onlyManagement() public {
        ...
        vm.prank(management);
        usd3Strategy.setMinDeposit(100e6);
        assertEq(usd3Strategy.minDeposit(), 100e6, "Min deposit should be updated");
    }
    ...
    function test_setPerformanceFee_onlyManagement() public {
        ...
        assertEq(ITokenizedStrategy(address(usd3Strategy)).performanceFee(), 1000, "Performance fee should be updated");
    }
    ...
    function test_setPerformanceFeeRecipient_onlyManagement() public {
        ...
        vm.prank(unauthorizedUser);
        vm.expectRevert();
        ITokenizedStrategy(address(usd3Strategy)).setPerformanceFeeRecipient(newRecipient);
    ...
    function test_setKeeper_onlyManagement() public {
        ...
        vm.prank(management);
        ITokenizedStrategy(address(usd3Strategy)).setKeeper(newKeeper);
        assertEq(ITokenizedStrategy(address(usd3Strategy)).keeper(), newKeeper, "Keeper should be updated");
    }
    ...
    function test_setProfitMaxUnlockTime_onlyManagement() public {
        ...
        vm.prank(unauthorizedUser);
        vm.expectRevert();
        ITokenizedStrategy(address(usd3Strategy)).setProfitMaxUnlockTime(20 days);
    ...
    function test_shutdownStrategy_onlyEmergencyAdmin() public {
        ...
        vm.prank(management);
        ITokenizedStrategy(address(usd3Strategy)).shutdownStrategy();
        assertTrue(ITokenizedStrategy(address(usd3Strategy)).isShutdown(), "Strategy should be shutdown");
    ...
    function test_setManagement_process() public {
        ...
        assertEq(
            ITokenizedStrategy(address(usd3Strategy)).management(), newManagement, "Management should be transferred"
        );
        assertEq(ITokenizedStrategy(address(usd3Strategy)).pendingManagement(), address(0), "Pending should be cleared");
    }
    ...
    function test_report_onlyKeeperOrManagement() public {
        ...
        // Keeper can report
        vm.prank(keeper);
        (uint256 profit1, uint256 loss1) = ITokenizedStrategy(address(usd3Strategy)).report();
        ...
        vm.prank(management);
        (uint256 profit2, uint256 loss2) = ITokenizedStrategy(address(usd3Strategy)).report();
    ...
    function test_zeroAddressProtection() public {
        ...
        vm.expectRevert();
        ITokenizedStrategy(address(usd3Strategy)).setPendingManagement(address(0));
