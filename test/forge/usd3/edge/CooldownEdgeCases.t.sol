...
contract CooldownEdgeCasesTest is Setup {
    ...
    function setUp() public override {
        ...
        address susd3Proxy =
            address(new TransparentUpgradeableProxy(address(susd3Implementation), susd3ProxyAdmin, susd3InitData));
    ...
    function test_cooldownDuringShutdown() public {
        ...
        vm.prank(alice);
        uint256 withdrawn = susd3Strategy.redeem(shares, alice, alice);
        assertGt(withdrawn, 0, "Should withdraw immediately after shutdown, bypassing cooldown");
    }
    ...
    function test_cooldownWithExcessAmount() public {
        ...
        assertEq(cooldownShares, shares, "Cooldown shares should be set to actual balance");
    ...
    function test_partialCooldownWithdrawals() public {
        ...
        assertEq(remainingCooldown, shares - shares / 4, "Cooldown should be reduced");
    ...
    function test_cooldownUpdateWithDifferentAmounts() public {
        ...
        (uint256 cooldownEnd2,, uint256 cooldownShares2) = susd3Strategy.getCooldownStatus(alice);
    ...
    function test_withdrawalWindowDurationChange() public {
        ...
        MockProtocolConfig(protocolConfigAddress).setConfig(SUSD3_WITHDRAWAL_WINDOW, 1 days);
    ...
    function test_shutdownBypassesAllRestrictions() public {
        ...
        vm.prank(alice);
        uint256 withdrawn = susd3Strategy.redeem(shares, alice, alice);
        assertGt(withdrawn, 0, "Should withdraw immediately after shutdown despite lock");
    }
    ...
    function test_shutdown_pending_cooldowns() public {
        ...
        vm.prank(alice);
        uint256 aliceWithdrawn = susd3Strategy.redeem(aliceShares, alice, alice);
    ...
    function test_emergency_admin_shutdown_powers() public {
        ...
        assertTrue(ITokenizedStrategy(address(susd3Strategy)).isShutdown(), "sUSD3 should be shutdown");
