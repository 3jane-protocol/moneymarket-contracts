...
contract PackedStructTest is Setup {
    ...
    function setUp() public override {
        ...
        bytes memory susd3InitData =
            abi.encodeWithSelector(sUSD3.initialize.selector, address(usd3), management, keeper);
    ...
    function test_packedUserCooldown_maxValues() public {
        ...
        (uint256 bobCooldownEnd, uint256 bobWindowEnd, uint256 bobCooldownShares) = susd3Strategy.getCooldownStatus(bob);

        // Verify large timestamps are handled correctly
        assertEq(bobCooldownShares, bobShares, "Bob's shares should match");
        assertGt(bobCooldownEnd, block.timestamp, "Bob's cooldown should be in future");
        assertGt(bobWindowEnd, bobCooldownEnd, "Bob's window should be after cooldown");
    }
    ...
    function test_packedUserCooldown_storageIntegrity() public {
        ...
        (uint256 cooldownEnd1, uint256 windowEnd1, uint256 shares1) = susd3Strategy.getCooldownStatus(alice);
        ...
        (uint256 cooldownEnd2, uint256 windowEnd2, uint256 shares2) = susd3Strategy.getCooldownStatus(alice);
    ...
    function test_packedUserCooldown_partialWithdrawal() public {
        ...
        assertEq(remainingShares, shares - partialShares, "Should have correct remaining shares");
        ...
        assertEq(finalShares, shares - partialShares - moreShares, "Should update correctly after multiple withdrawals");
    }
    ...
    function test_packedUserCooldown_overflow_protection() public {
        ...
        assertEq(cooldownShares, shares, "Large shares should be stored correctly");
        vm.stopPrank();
    }
