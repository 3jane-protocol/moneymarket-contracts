...
contract MorphoCreditTest is Test {
    ...
    function testSetBorrowerPremiumRate() public {
        ...
        (uint128 lastAccrualTime, uint128 rate,) = MorphoCredit(address(morpho)).borrowerPremiumDetails(marketId, borrower);
    ...
    function testSetBorrowerPremiumRateWithExistingPosition() public {
        ...
        (,, uint256 borrowAssetsAtLastAccrual) = MorphoCredit(address(morpho)).borrowerPremiumDetails(marketId, borrower);
    ...
    function testAccrueBorrowerPremium() public {
        ...
        uint256 borrowAssets = uint256(position.borrowShares).toAssetsUp(
    ...
    function testRepayTriggersSnapshotUpdate() public {
        ...
        (uint128 lastAccrualTime,, uint256 snapshot) = MorphoCredit(address(morpho)).borrowerPremiumDetails(marketId, borrower);
        assertEq(lastAccrualTime, block.timestamp);
