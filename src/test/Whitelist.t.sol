...
contract WhitelistTest is Setup {
    ...
    function test_setWhitelist_addAndRemove() public {
        ...
        assertEq(
            usd3Strategy.whitelist(alice),
            false,
            "Alice should not be whitelisted"
        );
    ...
    function test_whitelistEnforcement_preventNonWhitelistedDeposits() public {
        ...
        assertEq(
            strategy.availableDepositLimit(alice),
            type(uint256).max,
            "Alice should have no limit"
        );
        assertEq(
            strategy.availableDepositLimit(bob),
            0,
            "Bob should have 0 limit"
        );
    }
    ...
    function test_whitelistBypass_viaTransfer() public {
        ...
        assertGt(
            assets,
            0,
            "Bob should be able to withdraw transferred shares"
        );
    }
