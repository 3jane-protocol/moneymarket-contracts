...
contract sUSD3Coverage is Setup {
    ...
    function test_zeroUSD3Supply() public {
        ...
        assertGt(
            currentLimit,
            0,
            "Should have deposit limit with existing USD3 supply"
        );
    ...
    function test_emergencyShutdownWithdrawal() public {
        ...
        assertEq(
            withdrawn,
            2000e6,
            "Should withdraw full amount during shutdown"
        );
    }
    ...
    function test_partialWithdrawalCooldownUpdate() public {
        ...
        assertEq(
            finalCooldown,
            totalShares - firstWithdraw - secondWithdraw,
            "Cooldown should decrease more"
        );
    }
    ...
    function test_subordinationAtMaxCapacity() public {
        ...
        uint256 depositAmount = availableLimit > 100e6
            ? availableLimit - 100e6
            : availableLimit;
