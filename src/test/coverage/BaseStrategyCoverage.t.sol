...
contract BaseStrategyCoverage is Setup {
    ...
    function test_withdrawWithMaxLoss() public {
        ...
        assertGt(
            ...
            90000e6,
            "Alice should have received USDC"
        );
    }
    ...
    function test_redeemWithMaxLoss() public {
        ...
        vm.prank(alice);
        uint256 assetsReceived500 = usd3Strategy.redeem(
            redeemShares,
            alice,
            alice,
            500
    ...
    function test_emergencyWithdraw() public {
        ...
        assertLt(
            idleBefore,
            totalAssets / 10,
            "Most funds should be deployed to Morpho"
        );
        ...
        vm.prank(management);
        ITokenizedStrategy(address(usd3Strategy)).emergencyWithdraw(
            type(uint256).max
        );
        ...
        assertGt(
            idleAfter,
            (totalAssets * 9) / 10,
            "Most funds should be freed from Morpho"
        );
    ...
    function test_withdrawalHooks() public {
        ...
        (, , uint256 cooldownSharesBefore) = susd3Strategy.getCooldownStatus(
            alice
        );
        ...
        (, , uint256 cooldownSharesAfter) = susd3Strategy.getCooldownStatus(
            alice
        );
        assertLt(
            cooldownSharesAfter,
            cooldownSharesBefore,
    ...
    function test_sUSD3ShutdownBypass() public {
        ...
        uint256 limitBeforeShutdown = susd3Strategy.availableWithdrawLimit(
            alice
        );
        ...
        uint256 limitAfterShutdown = susd3Strategy.availableWithdrawLimit(
            alice
        );
        assertEq(
            limitAfterShutdown,
