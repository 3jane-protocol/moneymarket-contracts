...
// lib/aave-v3-periphery/contracts/misc/interfaces/IEACAggregatorProxy.sol
...
// lib/aave-v3-periphery/contracts/rewards/interfaces/IRewardsDistributor.sol
...
// lib/aave-v3-periphery/contracts/rewards/interfaces/ITransferStrategyBase.sol
...
// lib/aave-v3-core/contracts/interfaces/IACLManager.sol
...
// lib/aave-v3-core/contracts/dependencies/openzeppelin/contracts/IERC20Detailed.sol
...
// lib/aave-v3-periphery/contracts/rewards/libraries/RewardsDataTypes.sol
...
// lib/aave-v3-core/contracts/protocol/tokenization/base/IncentivizedERC20.sol
...
// src/libraries/MetaTxHelpers.sol
...
contract ATokenVault is ERC4626Upgradeable, OwnableUpgradeable, EIP712Upgradeable, ATokenVaultStorage, IATokenVault {
    ...
    function _maxAssetsSuppliableToAave() internal view returns (uint256) {
        ...
        DataTypes.ReserveData memory reserveData = AAVE_POOL.getReserveData(address(UNDERLYING));
