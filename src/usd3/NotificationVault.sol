 ...
 *         shares = nUSD3), so wrapped USD3 can serve as money-market collateral without being
...
contract NotificationVault is BaseHooksUpgradeable {
        ...
        initializer
    {
        ...
        __BaseStrategy_init(address(usd3), "Notification USD3", _management, _management, _keeper);
    }
    ...
    ///         donations into PPS; nUSD3 stays 1:1 with USD3 on deposit/withdraw alone.
    ...
    /// @param shares Number of nUSD3 shares to put into cooldown.
