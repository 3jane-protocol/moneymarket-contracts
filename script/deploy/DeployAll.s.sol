...
contract DeployAll is Script {
    ...
    function run() external returns (DeploymentAddresses memory addresses) {
        ...
        // Step 9: Deploy USD3 (Senior Tranche)
        console.log(">>> Step 9: Deploying USD3 (Senior Tranche)...");
        ...
        // Step 10: Deploy sUSD3 (Subordinate Tranche)
        console.log(">>> Step 10: Deploying sUSD3 (Subordinate Tranche)...");
        ...
        // Step 11: Deploy Helper (needed for token configuration)
        console.log(">>> Step 11: Deploying Helper...");
